...
RUN apt update && apt install -y docbook2x m4 build-essential autoconf flex bison libtool autopoint pkg-config libzstd-dev libssl-dev xxhash wget curl libssl-dev libtinfo-dev libreadline-dev libgmp-dev libmpfr-dev libexpat-dev liblzma-dev libffi-dev libbz2-dev libgdbm-dev libdb-dev uuid-dev
